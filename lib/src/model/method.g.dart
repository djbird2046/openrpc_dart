...
Method _$MethodFromJson(Map<String, dynamic> json) => Method(
      ...
      params: (json['params'] as List<dynamic>)
          .map((e) => ContentDescriptorRef.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      errors: (json['errors'] as List<dynamic>?)
          ?.map((e) => ErrorRef.fromJson(e as Map<String, dynamic>))
          .toList(),
      links: (json['links'] as List<dynamic>?)
          ?.map((e) => LinkRef.fromJson(e as Map<String, dynamic>))
          .toList(),
      paramStructure: json['paramStructure'] as String?,
    )..result = json['result'] == null
        ? null
        : ContentDescriptorRef.fromJson(json['result'] as Map<String, dynamic>);
